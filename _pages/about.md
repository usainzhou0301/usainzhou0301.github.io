...
<ul class="qz-pub">
  <li>"Joint Capacity Planning and Resource Allocation for UAV-Assisted Vehicular Fog Computing Using Deep Reinforcement Learning", Quanxi Zhou, Wencan Mao, Manabu Tsukada, Yu Xiao,<i> IEEE International Conference on Future Machine Learning And Data Science (FMLDS)</i> <span class="tag"></li>
